...
int main()
{
  ...
  } while (toupper(sMainChoice[0]) != 'M'); //When 'M' is inputted the program ends
...
bool validateDate(string sDateIn)
{
  ...
  {
    //(9/9/99)
    if ((ispunct(sDateIn[1]) && ispunct(sDateIn[3]))
        && (sDateIn[1] == sDateIn[3]))
    {
      sDateIn.insert(0, "0");
      sDateIn.insert(3, "0");
  ...
  {
    //(9/99/99)
    if ((ispunct(sDateIn[1]) && ispunct(sDateIn[4]))
        && (sDateIn[1] == sDateIn[4]))
    {
    ...
    //(99/9/99)
    else if ((ispunct(sDateIn[2]) && ispunct(sDateIn[4]))
        && (sDateIn[2] == sDateIn[4]))
    {
      sDateIn.insert(4, "0");
      string sDateInEnd = sDateIn.substr(6, 2);
  ...
  {
    //(99/99/99)
    if ((ispunct(sDateIn[2]) && ispunct(sDateIn[5]))
        && (sDateIn[2] == sDateIn[5]))
    {
      string sDateInEnd = sDateIn.substr(6, 2);
      int iTemp = atoi(sDateInEnd.c_str());
    ...
    //(9/9/9999)
    else if ((ispunct(sDateIn[1]) && ispunct(sDateIn[3]))
        && (sDateIn[1] == sDateIn[3]))
    {
      sDateIn.insert(0, "0");
      sDateIn.insert(3, "0");
